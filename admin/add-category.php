                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row needs-validation" method="POST" >
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input name="name" type="text" class="form-control" id="validationCustom01" placeholder="Type something" required />
                                        ...
                                        <div class="mb-0">
                                            <div>
                                                <button type="submit" class="btn btn-pink waves-effect waves-light" name="add_category">
                                                    Add catgeory
                                                </button>
                                            </div>
                                        </div>
